...
def scrape_page_business(offset):
...
def scrape_notice_context(link, title):
    """경영대학 공지사항 상세 페이지에서 내용을 크롤링하고 이미지를 S3에 업로드"""
    ...
    # 이미지 업로드
    image_tags = soup.select('#BoardContent img')
    image_urls = []
